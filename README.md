...
OR
- .NET 4.8. You can download from the official [Microsoft website](https://dotnet.microsoft.com/en-us/download/dotnet-framework/net48).

### Linux / macOS

- mono-complete on non Windows platforms, you can find out how to install mono [here](https://www.mono-project.com/docs/getting-started/install/). The reason that you need mono is because the tool requires .NET 4.7.2. or .NET 4.8. This tool cannot currently be build using .NET 6.0 or .NET Core because some of the dependencies are those used by the Visual Studio extension. The other reason why you need mono is to build a nanoFramework project.
